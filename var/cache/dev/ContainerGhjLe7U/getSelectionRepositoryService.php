...
// Returns the private 'App\Repository\SelectionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SelectionRepository.php';

return $this->privates['App\\Repository\\SelectionRepository'] = new \App\Repository\SelectionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
