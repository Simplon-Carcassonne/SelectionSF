...
include_once $this->targetDirs[3].'/src/DataFixtures/SelectionFixtures.php';
include_once $this->targetDirs[3].'/src/DataFixtures/UserFixtures.php';
include_once $this->targetDirs[3].'/src/DataFixtures/XCandidateFixtures.php';

$a = new \Doctrine\Bundle\FixturesBundle\Loader\SymfonyFixturesLoader($this);
$a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\SelectionFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\UserFixtures(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php'))), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\XCandidateFixtures(), 'groups' => []]]);
